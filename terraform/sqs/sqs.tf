...
output "backup_check_in_dl_queue_arn" {
    value = aws_sqs_queue.backup_check_in_dl_queue.arn
}
...
output "backup_compressor_dl_queue_arn" {
    value = aws_sqs_queue.backup_compressor_dl_queue.arn
}
